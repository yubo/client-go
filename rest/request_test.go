...
//		{
//			// non dynamic client
//			Request: NewRequestWithClient(uri, "", ClientContentConfig{}, nil).Verb("POST").
...
//			Request: NewRequestWithClient(uri, "", ClientContentConfig{}, nil).Verb("DELETE").
...
//			// /api/$RESOURCEVERSION/namespaces/$NAMESPACE/$RESOURCE/%NAME
//			Request: NewRequestWithClient(uriSingleSlash, "", ClientContentConfig{}, nil).Verb("DELETE").
...
//			}
//
//			require.Equal(t, expect, transformed)
//
...
//		r := NewRequestWithClient(u, "", ClientContentConfig{}, nil).Verb("POST").Prefix(tc.resourcePrefix).AbsPath(tc.absPath)
